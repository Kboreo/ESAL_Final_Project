...
//	double w,speed;
  ...
  SysCtlPeripheralEnable(SYSCTL_PERIPH_QEI0);
	...
	QEIConfigure(QEI0_BASE, (QEI_CONFIG_CAPTURE_A_B  | QEI_CONFIG_NO_RESET 	| QEI_CONFIG_QUADRATURE | QEI_CONFIG_NO_SWAP), 1799);  //maxima posicion
	...
	QEIVelocityConfigure(QEI0_BASE, QEI_VELDIV_1, 160000);//capture velocity after .01 seconds
